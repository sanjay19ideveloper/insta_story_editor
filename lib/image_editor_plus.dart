...
// // import 'package:photo_editor/image_editor_plus.dart'as o;
// import 'package:photo_tool/loading_screen.dart';
// import 'package:photo_tool/modules/layers_overlay.dart';
...
//     this.blurOption = const BlurOption(),
//     this.brushOption = const BrushOption(),
//     this.emojiOption = const EmojiOption(),
//     this.filtersOption = const FiltersOption(),
//     this.flipOption = const FlipOption(),
//     this.rotateOption = const RotateOption(),
//     this.textOption = const TextOption(),
//   });
...
//                                 padding: const EdgeInsets.all(0),
//                                 onPressed: () async {
//                                   // XFile? editedImage = await Navigator.push(
//                                   //   context,
//                                   //   MaterialPageRoute(
...
//   Future<dynamic?> getMergedImage() async {
...
//                         XFile? croppedImage = await Navigator.push(
//                           context,
//                           MaterialPageRoute(
...
//                         XFile? filterAppliedImage = await Navigator.push(
//                           context,
//                           MaterialPageRoute(
//                             builder: (context) => ImageFilters(
//                               image: mergedImage,
...
//   final XFile? image;
//   final List<CropAspectRatios> availableRatios;
...
//   Future<XFile?> cropImageWithThread({
...
//   final BoxFit? fit;
//   final Function(XFile)? onProcess;
...
//   final BrushOption options;

//   const ImageEditorDrawing({
//     super.key,
//     required this.image,
//     this.options = const BrushOption(
//       showBackground: true,
//       translatable: true,
//     ),
//   });
